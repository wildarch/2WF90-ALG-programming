...
class MultiplicationTableTest {
    ...
    fun `to String`() {
        ...
        val expected =
                ...
                """0 (ℤ/2ℤ)     |  0 (ℤ/2ℤ)   0 (ℤ/2ℤ)       0 (ℤ/2ℤ)       0 (ℤ/2ℤ)     """ + System.lineSeparator() +
                """1 (ℤ/2ℤ)     |  0 (ℤ/2ℤ)   1 (ℤ/2ℤ)       X (ℤ/2ℤ)       X + 1 (ℤ/2ℤ) """ + System.lineSeparator() +
                """X (ℤ/2ℤ)     |  0 (ℤ/2ℤ)   X (ℤ/2ℤ)       X + 1 (ℤ/2ℤ)   1 (ℤ/2ℤ)     """ + System.lineSeparator() +
                """X + 1 (ℤ/2ℤ) |  0 (ℤ/2ℤ)   X + 1 (ℤ/2ℤ)   1 (ℤ/2ℤ)       X (ℤ/2ℤ)     """
