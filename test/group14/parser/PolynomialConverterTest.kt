...
open class PolynomialConverterTest {
    ...
    fun `Parameter Representation`() {
        ...
        val testSet = mapOf(
                "2-X^5-3X^4-2*X^4- 1x^6-1" to 3 to "[1, 0, 0, 0, 1, 2, 2] (Z/3Z)",
                "6x^2-48x- 32X^2-6x-36x^3+25x^5-48x" to 29 to "[0, 14, 3, 22, 0, 25] (Z/29Z)",
                "-7x^4 - 3*x^5+17x^5" to 19 to "[0, 0, 0, 0, 12, 14] (Z/19Z)",
                "82x ^3 - 76 x^4+56x-90X^2+89x^6-4X^5+26X" to 47 to "[0, 35, 4, 35, 18, 43, 42] (Z/47Z)",
                "49 x^5-45x^6+77 x ^6-50x^3+16X^5-48*x^4 + 15x^6" to 43 to "[0, 0, 0, 36, 38, 22, 4] (Z/43Z)",
                "12X^3" to 7 to "[0, 0, 0, 5] (Z/7Z)",
                "-22  *x ^6" to 13 to "[0, 0, 0, 0, 0, 0, 4] (Z/13Z)",
                "-8x^6+8x^3" to 11 to "[0, 0, 0, 8, 0, 0, 3] (Z/11Z)",
                "-34x^2+ 15x^5+35x-78X+7" to 47 to "[7, 4, 13, 0, 0, 15] (Z/47Z)",
                "21x^3+19x^2+5+10X^3-19" to 11 to "[8, 0, 8, 9] (Z/11Z)",
                "0" to 13 to "[] (Z/13Z)",
                "6+ 6- 6+6 - 6 - 6+6" to 5 to "[1] (Z/5Z)"
        )
